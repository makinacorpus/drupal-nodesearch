...
/***/ "./src-front/components/dialog.tsx":
/*!*****************************************!*\
  !*** ./src-front/components/dialog.tsx ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./src-front/components/pager.tsx":
/*!****************************************!*\
  !*** ./src-front/components/pager.tsx ***!
  \****************************************/
/*! no static exports found */
    ...
    Pager.prototype.render = function () {
        ...
        var _loop_1 = function (i) {
            if (this_1.props.page === i) {
                pageLinks.push(React.createElement("li", { key: i, className: "active" }, React.createElement("a", { onClick: function () {
                        _this.props.onClick(i);
                    }, href: "#" }, i)));
            } else {
                pageLinks.push(React.createElement("li", { key: i }, React.createElement("a", { onClick: function () {
                        _this.props.onClick(i);
                    }, href: "#" }, i)));
            }
        };
        ...
        if (pageCount > 1) {
            if (this.props.page === 1) {
                firstPageLink = React.createElement("li", { className: "disabled" }, React.createElement("a", { key: "first", href: "#", "aria-label": this.props.previousLabel || "Previous" }, React.createElement("span", { "aria-hidden": "true" }, "\u00AB")));
            } else {
                firstPageLink = React.createElement("li", null, React.createElement("a", { key: "first", onClick: function () {
                        _this.props.onClick(1);
                    }, href: "#", "aria-label": this.props.previousLabel || "Previous" }, React.createElement("span", { "aria-hidden": "true" }, "\u00AB")));
            }
            if (this.props.page === pageCount) {
                lastPageLink = React.createElement("li", null, React.createElement("a", { key: "first", onClick: function () {
                        _this.props.onClick(pageCount);
                    }, href: "#", "aria-label": this.props.nextLabel || "Next" }, React.createElement("span", { "aria-hidden": "true" }, "\u00BB")));
            } else {
                lastPageLink = React.createElement("li", { className: "disabled" }, React.createElement("a", { href: "#", "aria-label": this.props.nextLabel || "Next" }, React.createElement("span", { "aria-hidden": "true" }, "\u00BB")));
            }
        }
...
/***/ "./src-front/components/preview.tsx":
/*!******************************************!*\
  !*** ./src-front/components/preview.tsx ***!
  \******************************************/
/*! no static exports found */
...
var ResultPreviewList = function (_super) {
    ...
    ResultPreviewList.prototype.render = function () {
        ...
        if (this.props.maxItemCount) {
            for (var i = this.props.data.length; i < Math.min(this.props.maxItemCount, 6); ++i) {
                placeholders.push("placeholder-" + i);
            }
        }
        return React.createElement("div", { className: classes.join(" ") }, this.props.data.map(function (item) {
            return React.createElement(ResultPreview, { key: item.id, item: item, active: -1 !== _this.props.active.indexOf(item.id), onClick: function () {
...
/***/ "./src-front/components/widget.tsx":
/*!*****************************************!*\
  !*** ./src-front/components/widget.tsx ***!
  \*****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var Core = __webpack_require__(/*! ../core */ "./src-front/core.ts");
var React = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var dialog_1 = __webpack_require__(/*! ./dialog */ "./src-front/components/dialog.tsx");
var pager_1 = __webpack_require__(/*! ./pager */ "./src-front/components/pager.tsx");
var preview_1 = __webpack_require__(/*! ./preview */ "./src-front/components/preview.tsx");
...
var SelectorWidget = function (_super) {
    ...
    SelectorWidget.prototype.onResetClick = function (event) {
        event.preventDefault();
        ...
        if (this.state.dialogOpened) {
            ...
            if (1 < types.length) {
                var _loop_1 = function (bundle) {
                    ...
                    checkboxes.push(React.createElement("label", null, React.createElement("input", { type: "checkbox", checked: checked, key: "filter-" + bundle, name: bundle, onClick: function (event) {
            ...
            dialog = React.createElement(dialog_1.Dialog, { title: this.props.title || "Search content", doClose: this.onCloseClick }, React.createElement("input", { name: "search", onChange: this.onSearchChange, placeholder: this.props.placeholder || "Type here some text to search content...", type: "text", value: searchValue }), checkboxes.length ? React.createElement("div", { className: "filter" }, checkboxes) : '', React.createElement(preview_1.ResultPreviewList, { active: active, data: result, onItemClick: this.valueAdd, maxItemCount: this.props.limit || WIDGET_DEFAULT_LIMIT }), React.createElement(pager_1.Pager, { onClick: function (page) {
                    return _this.refresh({ page: page });
                }, autoHide: false, page: page, total: total, limit: limit }), React.createElement("div", { className: "current" }, React.createElement("h2", null, "Current selection"), React.createElement(preview_1.ResultPreviewList, { active: active, data: this.state.values, onItemClick: this.valueRemove, maxItemCount: this.props.maxCount, removable: true, sortable: true })), React.createElement("div", { className: "footer" }, React.createElement("button", { className: "button btn btn-danger", name: "submit", onClick: this.onCancelClick }, "Cancel"), React.createElement("button", { className: "button btn btn-danger", name: "submit", onClick: this.onResetClick }, "Reset to defaults"), React.createElement("button", { className: "button btn btn-success pull-right", name: "submit", onClick: this.onCloseClick }, "Select")));
        }
        return React.createElement("div", { className: "node-selector" }, React.createElement(preview_1.ResultPreviewList, { active: active, data: this.state.values, onItemSort: function () {}, sortable: true }), React.createElement("button", { className: "btn btn-default", onClick: this.onOpenClick }, this.props.buttonTitle || "Select"), dialog);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./types/drupal */ "./src-front/types/drupal.ts");
var widget_1 = __webpack_require__(/*! ./components/widget */ "./src-front/components/widget.tsx");
...
/* harmony import */ var _less_style_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./less/style.less */ "./src-front/less/style.less");
...
/* harmony import */ var _drupal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./drupal */ "./src-front/drupal.ts");
/* harmony import */ var _drupal__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_drupal__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core */ "./src-front/core.ts");
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _core__WEBPACK_IMPORTED_MODULE_2__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _core__WEBPACK_IMPORTED_MODULE_2__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
/***/ 0:
/*!**************************************************************!*\
  !*** multi core-js/modules/es6.promise ./src-front/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
