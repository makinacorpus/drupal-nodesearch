(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["NodeSearch"] = factory(require("ReactDOM"), require("React"));
	else
		root["NodeSearch"] = factory(root["ReactDOM"], root["React"]);
...
function SelectorDialog(target, title) {
    var types = null;
    if (target.hasAttribute("data-type")) {
        types = target.getAttribute("data-type").split(",").map(function (value) {
            return value.trim();
        });
    }
    if (!title) {
    ...
    target.addEventListener("click", function (event) {
        ...
        var dialogElement = target.ownerDocument.createElement('div');
        target.ownerDocument.body.appendChild(dialogElement);
        dialog_1.renderDialog({
            title: title || "Select content",
            doRefresh: function doRefresh(search) {
                return doSearch(search);
            },
            doUpdate: function doUpdate(value) {
                target.value = value || "";
            },
...
exports.SelectorDialog = SelectorDialog;
...
function renderDialog(props, element) {
    ReactDOM.render(React.createElement(Selector, __assign({}, props)), element);
}
...
var Selector = function (_super) {
    ...
    Selector.prototype.refresh = function (search) {
        var _this = this;
        if (!search) {
            search = {};
        }
        ...
        this.props.doRefresh(search).then(function (result) {
    ...
    Selector.prototype.changeValue = function (value) {
    ...
    Selector.prototype.onSearchChange = function (event) {
        var _this = this;
    ...
    Selector.prototype.onRemoveClick = function () {
        this.props.doUpdate();
        this.props.doClose();
    };
    Selector.prototype.onSubmitClick = function () {
        this.props.doUpdate(this.state.value);
        this.props.doClose();
    };
    Selector.prototype.onCloseClick = function () {
        this.props.doClose();
    };
    Selector.prototype.onPageChange = function (page) {
    ...
    Selector.prototype.render = function () {
        ...
        if (this.state.result) {
            result.push(this.state.result.result.map(function (item) {
                return React.createElement("li", { key: item.id, "data-active": item.id === _this.state.value }, React.createElement("a", { onClick: function onClick() {
                        _this.changeValue(item.id);
                    } }, item.title));
            }));
        }
        var pager;
        ...
        return React.createElement("div", null, React.createElement("div", { className: "node-search-overlay" }), React.createElement("div", { className: "node-search-dialog" }, React.createElement("div", { className: "node-search-selector" }, React.createElement("h1", { className: "title" }, this.props.title, React.createElement("button", { name: "close", onClick: this.onCloseClick, className: "close" }, React.createElement("span", { className: "sr-only" }, "Close"))), React.createElement("div", { className: "header" }, React.createElement("input", { type: "text", name: "search", onChange: this.onSearchChange, placeholder: this.props.placeholder, value: searchValue })), React.createElement("ul", { className: "results" }, result), pager, React.createElement("div", { className: "footer" }, React.createElement("button", { className: "btn btn-danger", name: "remove", disabled: !this.state.value, onClick: this.onRemoveClick }, "Remove"), React.createElement("button", { className: "btn btn-success", name: "submit", disabled: !this.state.value, onClick: this.onSubmitClick }, "Select")))));
    };
    return Selector;
}(React.Component);
...
Drupal.behaviors.nodeSearch = {
    attach: function attach(context, settings) {
        for (var _i = 0, _a = context.querySelectorAll("[data-selector=\"true\"]"); _i < _a.length; _i++) {
            var widget = _a[_i];
            console.log("gotcha");
            core_1.SelectorDialog(widget);
        }
    }
};
...
var Pager = function (_super) {
    ...
    Pager.prototype.render = function () {
        ...
        return React.createElement("nav", { "aria-label": this.props.ariaLabel || "Page navigation" }, React.createElement("ul", { className: this.props.className || "pagination" }, firstPageLink, pageLinks, lastPageLink));
    };
    return Pager;
}(React.Component);
exports.Pager = Pager;
